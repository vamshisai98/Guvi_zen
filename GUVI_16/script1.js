...
async function getData() {
    try {
        ...
        let progressBar = creatingElement('div', 'progress', 'progressText')

        let progressFill = creatingElement('div', 'progress-bar', 'progress-bar')
        ...
        response.results.forEach((x => {
            ...
            let progressText = creatingElement('h6', 'progressText1 ml-2', 'progressText1')
